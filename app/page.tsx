    ...
    <div className="pb-24 sm:pb-0">
      ...
      <section className="relative flex flex-col items-center justify-center text-center px-6 py-32 sm:py-48 overflow-hidden bg-black min-h-[600px]">
        <Image
          ...
          priority
        />
        {/* Dark overlay with red + blue from logo */}
      ...
      {/* Info strip */}
      <section className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-neutral-800 border-y border-blue-900/40 bg-neutral-950">
        {[
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {featured.map(({ name, desc, price, tag, img }) => (
            <div key={name} className="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden hover:border-blue-800 transition-colors">
              {img && (
      ...
      {/* Loyalty teaser */}
      <section className="border-t border-blue-900/30 bg-neutral-950 py-16 px-4 sm:px-6 text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block border-2 border-blue-500 text-blue-400 hover:bg-blue-600 hover:text-white font-black uppercase tracking-wider px-6 py-3 rounded-full transition-colors text-sm"
        >
          Follow for Updates
        </a>
      </section>
